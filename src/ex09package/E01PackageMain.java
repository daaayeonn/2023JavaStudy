/*
 패키지 선언부 : 현재 작성하는 클래스의 위치를 결정하기 위한 선언으로 해당 클래스를 특정
 	패키지 하위에 묶어서 생성한다는 의미이다.
 */
...
public class E01PackageMain {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 방법 2 : 하나의 클래스는 import 하고, 다른 하나는 풀 패키지 경로를 기술한다.
		 */
		...
		/*
		 ...
		 호출 할 수 있다.
		 Java에서 제공하는 클래스 중 대표적으로 Math를 예로 들 수 있다.
		 난수생성을 위헤 별도의 인스턴스 생성없이 Math.random()을 호출하여 난수를 생성한다.
		 */
