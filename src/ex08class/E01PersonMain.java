...
/*
  ...
  preson 클래스는 "사람"의 일방적인 속성을 클래스로 추상화 한 것이다.
  
  클래스 선언 시 class 예약어를 사용한다. 클래스명의 첫글자는 반드시 대문자를 사용해야 한다.
...
class Person {
	...
	/*
	 멤버메서드 : 클래스에서 객체의 동작(헹위)를 표현한다. 클래스 외부에서 호출 할 때는
	 	참조변수를 통해 .(닷)으로 호출한다. 또한 멤버변수는 멤버메서드 내에서 즉시
	 	사용할 수 있다.
	 */
	void eat() {
...
public class E01PersonMain {
	...
	public static void main(String[] args) {
		...
		/*
		 Person 클래스를 통해 인스턴스를 생성한다. 생성 시 할당은 주소값을 반환하고,
