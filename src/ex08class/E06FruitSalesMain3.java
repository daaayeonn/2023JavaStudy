...
class FruitSeller3{
	...
	/*
	 멤버상수는 값의 변경이 불가능하고, 단 한 번만 초기화 되기때문에 일반 멤버메서드에서는 
	 초기화 할 수 없다. 또한 초기값이 없는 상태로 선언 자체가 불가능하다.
	 하지만 생성자는 인스턴스 생성 시 딱 한 번만 호출되고, 개발자가 마음대로 호출 할 수 
	 없으므로 한 번 이상 초기화되지 않음이 문법적으로 보장된다.
...
public class E06FruitSalesMain3 {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 따라서 초기화 메서드를 사용하는 것 보다 작은 코드로 작성할 수 있는 장점이 있다.
		 */
