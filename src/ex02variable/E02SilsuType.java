...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 실수자료형
		 - 정수형보다는 실수형이 더 큰 자료형이다. 0과 1 사이에 무수히 많은 실수가 존재하기
		 때문이다.
		...
		/*
		 ...
		 - 소수점이 있는 데이터를 float에 대입하려면 접미사 F(혹은 f)를 붙여야 한다.
		...
		/*
		 CPU는 실수계산에 기본적인 오차를 가지고있다. 이는 Java의 문제가 아니라 컴퓨터
		 자체의 문제이므로 정확한 계산을 위해서는 약간의 보정을 필요로한다.
		 */
	}
