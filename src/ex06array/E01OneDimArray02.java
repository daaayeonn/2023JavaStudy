...
public class E01OneDimArray02 {
	...
	public static void main(String[] args) {
		/*
		 난수생성방법1
		 : Math클래스의 random() 메서드는 0~1사이의 실수를 랜덤하게 변환해준다.
		 정수형태의 난수가 필요한 경우네는 10이나 100과 같은 정수를 곱해주면 된다.
		 */
		double rndNumber = Math.random();
		System.out.println("생성된난수[실수]: "+rndNumber);
		//정수와 실수를 연산하면 실수가 변환되므로 int로 강제형변환한다.
		...
		/*
		 ...
		 2. 45로 %연산하여 나머지를 구한다. 정수를 45로 나누면 나머지는 0~44사이가 된다.
