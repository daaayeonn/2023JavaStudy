...
public class E02ArrayAndMethod {
	...
	public static void main(String[] args) {
		...
		/*
		 배열을 선언과 동시에 초기화한다. 초기값의 갯수를 통해 크기가 결정된다. 생성된
		 배열 인스턴스의 주소값을 int형 배열변수인 arr에 할당하게된다.
		 */
		int[] arr = {1, 2, 3, 4, 5};
		 ...
		 * @가 포함된 형태가 된다. 즉 배열명을 배열에 저장된 값 자체가 아닌 힙영역에
		 * 생성된 메모리 주소값을 저장하게된다.*/
		...
		/*
		 ...
		 결국 동일한 배열을 참조하게되어 아래 출력문에서는 동일한 결과가 2번 출력된다.
		 */
	...
	/*
	 매개변수로 전달된 배열의 참조값을 ar로 받게되므로 해당 메서드에서도 동일한 배열을
	 참조할 수 있게된다. 즉 main메서드에서 생성한 배열과 동일한 배열을 참조하게된다.
	 */
	static int[] addAllArray(int[] ar, int addVal) {
		/*
		 배열의 각 인덱스에 매개변수로 전달된 7을 더해준다. 즉 각 원소를 7씩 증가시킨다.
		 */
