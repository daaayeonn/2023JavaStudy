...
/*
 while문
 : 반복의 횟수가 명확히 정해져있지 않았을때 주로 사용하는 반복문으로 반복을 위한 초기값, 조건식,
 증감식을 따로 작성하는 형식을 가지고있다.
 형식]
 	반복을 위한 변수의 초기값;
 	while(반복의조건){
 		실행문장;
...
public class E03While {
	...
	public static void main(String[] args) {
		...
		while(j<=10) {
			//sum = sum + j;
			/*
			 복합대입연산자를 통해 증가하는 j의 값을 sum에 누적해서 더해준다.
			 */
			sum += j; // sum = sum + j;
			//반복문 탈출을 위한 증가식
			j++;
		...
		/*
		 시나리오] 1~100까지의 정수중 3의 배수이거나 4의 배수인 정수의 합을 구하는 프로그램을
		 while 문을 이용해서 작성하시오.
		 */
		...
		/*
		 시나리오] 구구단을 출력하는 프로그램을 while 문으로 작성하시오.
		 */
		//단을 표현한 변수
		int dan = 2;
		//단에 대한 조건(2~9단까지)
