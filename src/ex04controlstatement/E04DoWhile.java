...
/*
 do~while문
 : 반드시 한번은 실행해야 할 경우 사용하는 반복문으로 저건검사없이 무조건 한번은 실행된다.
 형식]
 	반복을 위한 변수;
 	do {
 		실행문;
...
public class E04DoWhile {
	...
	public static void main(String[] args) throws IOException {
		...
		/*
		 시나리오] 1부터 1000까지의 정수중 4의 배수이거나 7의 배수인 수의 합을
		...
		*/
		...
		do {
			...
			/*
			 평균점수와 구간을 정하기 위해 10으로 나누는 연산을 추가한다.
			 switch문은 조건식은 사용할수없고 산술식만 사용할 수 있으므로 이와같이
			 처리해야한다.
			 */
