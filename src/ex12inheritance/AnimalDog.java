...
//	}
	...
	void showDog() {
		/*
		 여기서 사용된 super는 부모클래스의 객체를 가리키는 의미로 부모클래스의 showAnimal()
		 메소드를 호출한다.
		 */
		super.showAnimal();
	...
	public AnimalDog(String species, int age, String gender, 
		...
		/*
		 자식 클래스에서는 반드시 부모클래스의 객체를 먼저 생성해야 한다. 여기서 사용된 super()는
		 반드시 부모클래스의 생성자 메소드를 호출하는 용도로 사용도니다.
		 */
