...
/*
 ...
 : 메서드 오버로딩을 대체할 수 있는 문법으로 하나의 메서드로 여러가지 호출형식을 대처할 수 있다.
 형식]
 	메서드명(자료형 ... 매개변수명) {
 		실행문장;
 	}
 	- 필요에 따라 매개변수를 가변적으로 조정할 수 있는 문법
 	- 매개변수를 2개 이상의 인수를 받을 수 있어야 하므로 배열로 반환
 	- 단, 자료형은 모두 동일해야 한다.
 */

public class E08VariableArgument {
	
	// 앞에서 학습한 메서등 오버로딩을 통한 메서드 정의 (여러개를 만들기는 어렵다)
...
//	}
	...
	/*
	 ...을 통해 매개변수 param이 2개 이상의 인수를 받을 수 있는 것을 명시한다.
	...
	public static void main(String[] args) {
		...
		/*
		 매개변수의 타입이 double이 포함되어 있으므로 호출할 수 없다. 만약 아래와 같이
		 실수를 모두 처리하려면 가변인자 타입을 double로 선언하면 된다.
		 */
//		System.out.println("getTotal(args1, args2) 호출: " +
//				getTotal(10, 20.3));
	}
