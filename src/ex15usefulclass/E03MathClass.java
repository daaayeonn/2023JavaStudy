...
/*
 Java의 규칙 : java.lang 패키지 하위에 모든 클래스는 자동으로 import 된다.
 	또한 정의하는 모든 클래스는 Object를 상속받게 되어있다.
 	따라서 java.lang 패키지의 모든 클래스는 별도의 선언없이 사용할 수 있고, Object에서
 	제공하는 메서드는 오버라이딩이 가능하다.
 */
// 생략 가능
import java.lang.*;
...
public class E03MathClass extends Object {
	...
	public static void main(String[] args) {
		...
		/*
		 ...
		 따라서 3.4xxxx라면 버림처리를 하게된다.
		 */
		System.out.println("### 반올림 ###");
		System.out.println("Math.round: " 
				+ Math.round(3.49999)); // 버림처리 : 3
		System.out.println("Math.round: " 
				+ Math.round(3.54444)); // 올림처리 : 4
		...
		/*
		 0 ~ 1 사이의 실수를 랜덤하게 반환한다. 따라서 정수값을 만들 때는 특정 수를 곱한 후
		 정수로 형변환해야한다.
		 */
